...
const fallbackPartnerBanners: PartnerBanner[] = [
  {
    ...
    description_ar: 'سجل متجرك الآن واحصل على ٣ شهور بدون عمولة',
    description_en: 'Register your store and get 3 months commission-free',
    badge_text_ar: '٣ شهور مجاناً',
    badge_text_en: '3 Months Free',
