...
export const CustomerHeader = memo(function CustomerHeader({
  ...
  return (
    <header
      className={`sticky top-0 z-[var(--z-header,40)] pt-[var(--safe-area-top,env(safe-area-inset-top,0px))] ${transparent ? 'bg-transparent' : 'bg-white/95 backdrop-blur-md border-b border-slate-100/80'}`}
    >
