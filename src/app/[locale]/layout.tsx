...
export function generateMetadata() {
  return {
    ...
    title: 'Engezna - إنجزنا - انجزنا | محلات بلدك في إيدك',
    description:
      'منصة إنجزنا (انجزنا) لتلبية احتياجات البيت اليومية من محلات بلدك: مطاعم، سوبر ماركت، صيدليات، خضروات وفاكهة، بن وحلويات. اطلب بضغطة من أي مكان في مصر.',
    ...
    openGraph: {
      title: 'إنجزنا | محلات بلدك في إيدك 💙',
      description:
        'اطلب احتياجات بيتك اليومية من محلات بلدك: مطاعم، سوبر ماركت، صيدليات، خضروات، حلويات. للتجار: 0% عمولة أول 3 شهور!',
      url: 'https://www.engezna.com',
      siteName: 'إنجزنا - Engezna',
      locale: 'ar_EG',
    ...
    twitter: {
      ...
      title: 'إنجزنا | محلات بلدك في إيدك 💙',
      description: 'اطلب احتياجات بيتك اليومية من محلات بلدك. للتجار: 0% عمولة أول 3 شهور!',
