  ...
  function getActionConfig(action: 'approve' | 'reject' | 'pause' | 'resume') {
    const configs = {
      approve: {
        ...
        message: {
          ar: 'هل تريد قبول هذا المتجر؟ سيتمكن من البدء في استقبال الطلبات فوراً.',
          en: 'Approve this provider? They will be able to start receiving orders immediately.',
        },
      ...
      reject: {
        ...
        message: {
          ar: 'هل تريد رفض هذا المتجر؟ سيتم إخطار صاحب المتجر بالقرار.',
          en: 'Reject this provider? The owner will be notified of this decision.',
        },
      ...
      pause: {
        ...
        message: {
          ar: 'هل تريد إيقاف هذا المتجر مؤقتاً؟ لن يتمكن من استقبال طلبات جديدة.',
          en: "Suspend this provider temporarily? They won't be able to receive new orders.",
        },
      ...
      resume: {
        ...
        message: {
          ar: 'هل تريد إعادة تفعيل هذا المتجر؟ سيتمكن من استقبال الطلبات مرة أخرى.',
          en: 'Reactivate this provider? They will be able to receive orders again.',
        },
          ...
          <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-slate-600">
                {locale === 'ar' ? 'إجمالي المتاجر' : 'Total Providers'}
              </span>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder={
                  locale === 'ar' ? 'بحث بالاسم أو الهاتف...' : 'Search by name or phone...'
                }
                value={searchQuery}
            ...
            >
              ...
              <option value="temporarily_paused">
                        ...
                        <div className="flex items-center justify-center gap-1">
                          ...
                          {['open', 'closed'].includes(provider.status) && (
                            <Button
                              ...
                              className="h-8 w-8 p-0"
                              onClick={() =>
                                openConfirmModal(provider, 'pause', 'temporarily_paused')
                              }
                  ...
                  <div className="mb-6">
                    <div
                      className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${
                        confirmAction.action === 'approve' || confirmAction.action === 'resume'
                          ? 'bg-green-100'
