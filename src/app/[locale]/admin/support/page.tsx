        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
          ...
          <div className="bg-card-bg-primary rounded-xl p-4 border border-primary/30">
            ...
            <p className="text-2xl font-bold text-primary">
              {formatNumber(stats.inProgress, locale)}
            </p>
          </div>
          <div className="bg-card-bg-success rounded-xl p-4 border border-success/30">
            ...
            <p className="text-2xl font-bold text-success">
              {formatNumber(stats.resolved, locale)}
            </p>
          </div>
                ...
                {filteredTickets.length > 0 ? (
                  filteredTickets.map((ticket) => (
                    <tr key={ticket.id} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center gap-1.5 text-xs px-2 py-1 rounded-full ${getStatusColor(ticket.status)}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <span
                          className={`inline-flex items-center gap-1.5 text-xs px-2 py-1 rounded-full ${getPriorityColor(ticket.priority)}`}
                        >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="text-sm text-slate-600">
                            {formatNumber(ticket.messages_count, locale)}
                          </span>
                        </div>
                      </td>
                      <td className="px-4 py-3">
