          ...
          <div className="bg-card-bg-success rounded-xl p-4 border border-success/30">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-sm text-success">
                {locale === 'ar' ? 'مكتملة اليوم' : 'Completed Today'}
              </span>
            </div>
            <p className="text-2xl font-bold text-success">
              {formatNumber(stats.completedToday, locale)}
            </p>
          </div>
                ...
                >
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span
                            className={`px-2 py-0.5 rounded text-xs font-medium ${priorityConfig[task.priority]?.color}`}
                          >
                      ...
                      <span
                        className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium ${statusConfig[task.status]?.color}`}
                      >
                  ...
                  <div className="p-4 bg-slate-50">
                    <div className="flex flex-wrap gap-4 text-sm">
                      ...
                      {task.deadline && (
                        <div
                          className={`flex items-center gap-2 ${overdue ? 'text-red-600' : 'text-slate-600'}`}
                        >
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-slate-700">
                    {locale === 'ar'
                      ? 'يتطلب موافقة المدير على النتيجة'
                      : 'Requires manager approval on completion'}
                  </span>
                </label>
                <label className="flex items-center gap-3">
                  <input
