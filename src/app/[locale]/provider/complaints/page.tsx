  ...
  if (loading) {
    return (
      <ProviderLayout
        ...
        pageSubtitle={{
          ar: 'متابعة والرد على شكاوى العملاء',
          en: 'Track and respond to customer complaints',
        }}
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-500">
              {isArabic
                ? 'متابعة والرد على شكاوى العملاء'
          ...
          <Card className="border-yellow-200 bg-yellow-50">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-600">{isArabic ? 'مفتوحة' : 'Open'}</p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">{isArabic ? 'تم الحل' : 'Resolved'}</p>
              </div>
            </CardContent>
          </Card>
        </div>
          ...
          <div>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-3 mb-4">
                ...
                <TabsTrigger value="waiting">{isArabic ? 'انتظار' : 'Waiting'}</TabsTrigger>
                <TabsTrigger value="resolved">{isArabic ? 'محلولة' : 'Resolved'}</TabsTrigger>
              </TabsList>
