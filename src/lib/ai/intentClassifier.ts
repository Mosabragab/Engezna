...
- product_info: يسأل عن وصف أو مكونات منتج معين - مش بيدور عليه! (مثال: "بيتزا نيويورك عبارة عن ايه"، "الكشري فيه ايه"، "مكونات البرجر"، "الطبق ده بيتكون من ايه"، "وصف المنتج"، "فيها ايه")
...
تحذير مهم:
- لو المستخدم بيسأل "X عبارة عن ايه" أو "X فيها ايه" أو "مكونات X" ← ده product_info مش search_product!
- product_info = سؤال عن وصف/مكونات
- search_product = بحث عن منتج عايز يطلبه

ملاحظات مهمة:
1. المصريين بيكتبوا بأخطاء إملائية كتير (امس = امسح، شيله = شيل، الغيه = الغي)
2. اللهجة المصرية: "عايز"، "عاوز"، "نفسي في"، "جيبلي"، "هاتلي"
3. لو الرسالة فيها اسم منتج، استخرجه في product_name
