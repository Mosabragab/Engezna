...
الأنواع المتاحة:
- search_product: يبحث عن منتج أو أكل (مثال: "عايز بيتزا"، "ابحث عن برجر"، "فين الكشري")
...
- delivery_info: يسأل عن التوصيل أو الشحن (مثال: "بكام التوصيل"، "الدليفري كام"، "في توصيل")
