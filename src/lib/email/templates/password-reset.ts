                    ...
                    <tr>
                        <td style="padding: 40px 28px; text-align: center; background-color: #ffffff;">
                            ...
                            <p style="color: #475569; font-size: 15px; line-height: 1.75; margin: 0 0 24px 0;">
                                مرحباً ${data.userName}، تلقينا طلباً لإعادة تعيين كلمة المرور الخاصة بحسابك.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding: 0 0 32px 0;">
                                        <a href="${data.resetUrl}" style="display: inline-block; background-color: #009DE0; color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-weight: 700; font-size: 16px;">إعادة تعيين كلمة المرور</a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 16px 20px; text-align: center;">
                                        <p style="margin: 0; font-size: 13px; color: #92400E;">
                                            هذا الرابط صالح لمدة ${data.expiryTime} فقط
                                        </p>
                                    </td>
                                </tr>
                            </table>
