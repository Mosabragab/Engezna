...
export const PRICING_DETECTION_PATTERNS = {
  ...
  sheetNames: {
    ...
    variants_weight: ['مشويات', 'كباب', 'لحوم', 'grills', 'meat', 'kebab', 'أوزان', 'weights'],
    variants_size: ['بيتزا', 'pizza', 'أحجام', 'sizes', 'مطعم', 'restaurant'],
    variants_coffee: ['قهوة', 'coffee', 'جرامات', 'grams'],
  },
  ...
  columnHeaders: {
    ...
    unit: ['الوحدة', 'unit', 'وحدة', 'كيلو', 'كجم', 'kg', 'kilogram'],
    // Single price indicators
    singlePrice: ['السعر', 'price', 'سعر'],
  },
} as const;
