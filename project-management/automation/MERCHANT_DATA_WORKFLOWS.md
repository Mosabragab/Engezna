...
| WF2      | `wf2_new_merchant_discovery.json` | اكتشاف متاجر جديدة في 5 مناطق × 7 فئات             |
...
```
الشيت الحالي: "مدينة بني سويف"
Sheet ID: 1HTjVdxyh8Uhz1lMbe6CEvdSHXfzgwmlo96Cz6ZPrHU8

شيتات البيانات الموجودة (لا تعدّل عليها):
   - لوحة التحكم          ← Dashboard بالإحصائيات
   - مطاعم 🍽️            ← بيانات المطاعم
   - صيدليات 💊           ← بيانات الصيدليات
   - سوبر ماركت 🛒        ← بيانات السوبرماركت
   - حلويات وكافيهات ☕    ← بيانات الحلويات والكافيهات
   - خضار وفواكه 🥬       ← بيانات الخضار والفواكه
   - متابعة CRM           ← متابعة التواصل

⚠️ هيكل كل شيت:
   - صف 1-2: عنوان ومعلومات (merged)
   - صف 3: أسماء الأعمدة (headers)
   - صف 4+: البيانات الفعلية
   - الأعمدة: اسم المتجر | الفرع الرئيسي | العنوان | المنطقة | رقم الهاتف 1 | رقم الهاتف 2 | فيسبوك | انستجرام | جوجل ماب | ...

أنشئ شيتات إضافية فارغة (للنتائج):
   - enrichment_results    ← نتائج الإثراء من WF1
   - not_found_log         ← متاجر لم يتم العثور عليها
   - متاجر_مكتشفة         ← متاجر جديدة من WF2
   - all_merchants         ← انسخ فيه كل المتاجر من كل الشيتات (لـ WF2)
   - merged_final          ← النتائج النهائية المدمجة من WF3
   - تقرير_التحديث        ← تقرير الإحصائيات
   - سجل_التحديثات        ← سجل كل التحديثات

⚠️ لو Service Account: شير الـ Sheet مع إيميل الـ SA
```
...
- أسماء الشيتات المتاحة: `'مطاعم 🍽️'` | `'صيدليات 💊'` | `'سوبر ماركت 🛒'` | `'حلويات وكافيهات ☕'` | `'خضار وفواكه 🥬'`
...
- يبحث في 5 مناطق في بني سويف × 7 فئات = 35 عملية بحث
...
مطاعم، صيدليات، سوبر ماركت، حلويات، كافيهات، خضار وفواكه، أكل بيتي
...
- يقرأ كل الشيتات الأصلية (6 فئات)
