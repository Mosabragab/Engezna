...
## ⚠️ ملاحظة مهمة - ميزات معطلة مؤقتاً

### المساعد الذكي (AI Assistant - أحمد)

- **الحالة:** 🔴 معطل مؤقتاً (يناير 2026)
- **السبب:** النظام لا يزال قيد التطوير وغير محكم بشكل كافٍ للإطلاق
- **للتفعيل:** `NEXT_PUBLIC_AI_ASSISTANT_ENABLED=true` في `.env`
- **التوثيق الكامل:** [docs/features/AI_SMART_ASSISTANT.md](docs/features/AI_SMART_ASSISTANT.md)
