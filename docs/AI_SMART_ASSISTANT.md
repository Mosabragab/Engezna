...
> **حالة المشروع:** ✅ تم إعادة البناء بالكامل - AI Agent Architecture (v2.0)
...
| Tool | الوصف |
|------|-------|
| `get_provider_promotions` | عروض تاجر معين |
...
*آخر تحديث: 15 ديسمبر 2025 - إعادة بناء كاملة باستخدام AI Agent Architecture*
