...
- [ ] كل الحسابات تستخدم `Money` class أو `decimal.js`
- [ ] التخزين بالقروش (integers) أو `DECIMAL(12,2)` في DB
- [ ] لا توجد أخطاء تقريب في العمولات
- [ ] اختبارات للحالات الحدية (0.1 + 0.2 = 0.3)

### 7. حالة الطلبات المعلقة (Hold Status) ⚖️
- [ ] الطلبات المتنازع عليها لا تدخل التسويات
- [ ] حقل `settlement_status` موجود في جدول `orders`
- [ ] Trigger تلقائي عند فتح نزاع
- [ ] الأدمن يرى تنبيه "طلبات معلقة" عند إنشاء التسوية

### 8. سجل التدقيق (Audit Trail) 📋
- [ ] كل تغيير في التسوية مسجل
- [ ] تسجيل: من، متى، ماذا، رقم المرجع
- [ ] عرض السجل في صفحة تفاصيل التسوية
