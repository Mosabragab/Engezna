...
> **الحالة:** 🔴 يجب الإصلاح قبل الإطلاق
...
- [ ] حماية مسارات `/provider/*` من العملاء
- [ ] حماية مسارات `/admin/*` من العملاء والتجار
- [ ] إعادة توجيه المستخدمين غير المسجلين من `/orders` و `/profile`
- [ ] إضافة رسائل خطأ مناسبة للوصول غير المصرح
