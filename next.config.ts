    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://accounts.google.com https://apis.google.com https://checkout.kashier.io https://*.firebaseio.com https://www.googletagmanager.com https://js.sentry-cdn.com https://vercel.live https://*.vercel.app https://static.cloudflareinsights.com",
              "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://accounts.google.com",
              "font-src 'self' https://fonts.gstatic.com",
              "img-src 'self' data: blob: https://*.supabase.co https://lh3.googleusercontent.com https://*.googleusercontent.com https://vercel.live",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://accounts.google.com https://oauth2.googleapis.com https://www.googleapis.com https://api.kashier.io https://checkout.kashier.io https://*.firebaseio.com https://fcm.googleapis.com https://*.here.com https://*.sentry.io https://vercel.live https://*.ingest.sentry.io https://cloudflareinsights.com https://static.cloudflareinsights.com https://*.vercel-insights.com https://va.vercel-scripts.com",
