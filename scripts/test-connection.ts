...
async function testConnection() {
  try {
    ...
    if (bucketsError) {
      ...
      console.log('   Buckets:', bucketsData.length > 0 ? bucketsData.map(b => b.name).join(', ') : 'No buckets found')
    }
    console.log('')
    ...
    console.log('   3. Or use Supabase Dashboard: https://supabase.com/dashboard/project/cmxpvzqrmptfnuymhxmr/editor')
    console.log('')
    ...
    console.error('   2. Verify credentials at: https://supabase.com/dashboard/project/cmxpvzqrmptfnuymhxmr/settings/api')
