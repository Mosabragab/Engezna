...
-- إضافة قالب إيميل دعوة المشرفين
-- ============================================================================
-- Version: 1.0
-- Created: 2026-01-20
-- Description: Add the admin invitation email template to the database
...
VALUES (
  'admin-invitation',
  'دعوة مشرف جديد',
  'يُرسل للمشرف الجديد عند دعوته للانضمام لفريق الإدارة',
  'دعوة للانضمام لفريق إدارة إنجزنا - {{roleName}}',
  E'<!DOCTYPE html>
                    ...
                    <tr>
                        <td style="padding: 40px 28px; text-align: center; background-color: #ffffff;">
                            ...
                            <p style="color: #475569; font-size: 15px; line-height: 1.75; margin: 0 0 24px 0;">
                                مرحباً {{adminName}}، قام {{inviterName}} بدعوتك للانضمام لفريق إدارة إنجزنا
                            </p>
                            ...
                            <!-- Role Info -->
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #F0F9FF; border-radius: 12px; margin-bottom: 24px; border-right: 4px solid {{roleColor}};">
                                <tr>
                                        ...
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 14px; color: #475569;">
                                                    ...
                                                    <span style="display: inline-block; background-color: {{roleColor}}; color: white; padding: 4px 12px; border-radius: 20px; font-size: 13px;">{{roleName}}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 14px; color: #475569;">
                                            ...
                                            <tr>
                                                <td style="padding: 8px 0; font-size: 14px; color: #475569;">
                                                    <strong style="color: #0F172A;">⏰ صالحة لمدة:</strong> {{expiresIn}}
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td align="center" style="padding: 0 0 32px 0;">
                                        <a href="{{inviteUrl}}" style="display: inline-block; background-color: #009DE0; color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-weight: 700; font-size: 16px;">قبول الدعوة والتسجيل ←</a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 16px 20px; text-align: center;">
                                        <p style="margin: 0; font-size: 13px; color: #92400E;">
                                            ⚠️ هذه الدعوة صالحة لمدة {{expiresIn}} فقط
                                        </p>
                                    </td>
                                </tr>
                            </table>
