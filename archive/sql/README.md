...
- `quick_fix_messages_permission.sql` - Messages permission fix
...
- `sync_admin_users_to_roles.sql` - Admin roles sync
- `verify_and_seed_roles.sql` - Roles verification
- `check_email_confirmation.sql` - Email confirmation check
